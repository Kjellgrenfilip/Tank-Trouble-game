    ...
    :   paus{false}, endgame{false}, players{}, game_map{}   // Initiera game_map här   
{
	...
	players.push_back(Player(Resource_Manager::get_texture_player(1), sf::Vector2f{screen_width/2, screen_height/2}, 1));
	players.push_back(Player(Resource_Manager::get_texture_player(1), sf::Vector2f{screen_width/3, screen_height/2}, 2));
}
