...
class Resource_Manager
{
    ...
    private:
        ...
        static inline sf::Texture bullet_texture;
        ...
        static inline sf::SoundBuffer speed_sound;
    ...
    public:
        ...
        static sf::Texture& get_texture_bullet();
        ...
        static sf::SoundBuffer& get_soundbuffer_speed();
